...
<form class="w-25" method="POST" action="crud/CheckAccount.php" style="margin:auto;">
  <div class="form-group">
    <label for="login" style="color:white; font-size:18px;">Login</label>
    <input type="text" id="login" name="login" class="form-control" placeholder="Renseignez votre Login" required>
  </div>
  <div class="form-group">
    <label for="password" style="color:white; font-size:18px;">Mot de Passe</label>
  ...
  <a href="crud/CreateUser.php" style="font-size:16px; margin-top:3%;" class="btn btn-primary">
    Create an account
  </a>
</form>
