...
<form>
  <div class="row" style="margin-top: 2vw;">
    ...
    <div class="col">
      <input type="text" id='mineral' name='classification' style="margin-left: 3vw; margin-right: 3vw; width: 40vw"class="form-control" placeholder="mineral classification">
    </div>
